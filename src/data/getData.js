...
brand
var watch = Object.keys(imagesMap).reduce((acc, key , i) => {

    if(imagesMap[key].length !== 0) {
        var newwatch = {
            price: getRandomArbitrary(1500, 10000),
            wire: "1.3GHz Apple A6",
        ...
        newwatch.title = key;
        newwatch.brand = key.split(' ')[0].toLowerCase();
        newwatch.category = 'watch';
        newwatch.images = imagesMap[key];
